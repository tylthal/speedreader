...
export default defineConfig({
  testDir: './e2e',
  testMatch: [/app-smoke\.spec\.ts$/, /bookmark-reader\.spec\.ts$/, /centering-check\.spec\.ts$/, /bookmark-scroll-playback\.spec\.ts$/, /pip-playback-start\.spec\.ts$/, /pip-consistency\.spec\.ts$/, /pip-restore-stress\.spec\.ts$/],
